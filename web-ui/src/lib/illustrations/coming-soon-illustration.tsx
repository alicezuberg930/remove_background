  ...
  return (
    <div {...other}>
      <svg width="100%" height="100%" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
        ...
        <path className="fill-primary/80" d="M58.778 79.4l14.6-6 80.2 7.5v7.6l-94.8.3v-9.4z" />
        <path className="fill-primary" d="M85.279 71h-14.4v199.5h14.4V71z" />
        <path
          fill="#fff"
        ...
        <path className="fill-primary" d="M188.179 244h-70v18.2h70V244z" />
        <path
          fill="#fff"
